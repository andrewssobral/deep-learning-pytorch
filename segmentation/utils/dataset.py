...
class VOCTestNoLabel(Dataset):
    def __init__(self, root, input_transform=None, target_transform=None):
        self.images_root = os.path.join(root, 'JPEGImages_test')
...
class VOCBSTest(Dataset):

    def __init__(self, root, input_transform=None, target_transform=None):
        self.images_root = os.path.join(root, 'JPEGImages_test')
        self.labels_root = os.path.join(root, 'SegmentationClass_test')
